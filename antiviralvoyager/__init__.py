...
def infection_results():
    #print(request.args)
    result = ibm_utils.query_US(request.args['year'], request.args['month'], request.args['state'], request.args['setting'], request.args['state'], request.args['year'], request.args['disaster'])
